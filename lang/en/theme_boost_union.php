...
$string['sliderpositiononfrontpage_desc'] = '"Instead of Content" will hide all other content on the front page!';
...
$string['sliderfrontpagepositionsetting_instead'] = 'instead of page content';
