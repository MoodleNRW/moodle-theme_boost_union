...
if ($hassiteconfig || has_capability('theme/boost_union:configure', context_system::instance())) {
    ...
    // @codingStandardsIgnoreLine
        ...
        $description = get_string('sliderpositiononfrontpage_desc', 'theme_boost_union', array('url' => $url), true);
        $setting = new admin_setting_configselect($name, $title, $description,
        ...
        for ($i = 1; $i <= THEME_BOOST_UNION_SETTING_SLIDES_COUNT; $i++) {
            ...
            $description = get_string('oneslidepickimage_desc', 'theme_boost_union', array('no' => $i), true);
            ...
            $title = get_string('oneslideimagetitle', 'theme_boost_union', array('no' => $i), true);
            $description = get_string('oneslideimagetitle_desc', 'theme_boost_union', array('no' => $i), true);
            $setting = new admin_setting_configtext($name, $title, $description, "");
            $tab->add($setting);
            ...
            $title = get_string('oneslidelink', 'theme_boost_union', array('no' => $i), true);
            $description = get_string('oneslidelink_desc', 'theme_boost_union', array('no' => $i), true);
            $setting = new admin_setting_configtext($name, $title, $description, "");
            $tab->add($setting);
            ...
            $title = get_string('oneslidelinktitle', 'theme_boost_union', array('no' => $i), true);
            $description = get_string('oneslidelinktitle_desc', 'theme_boost_union', array('no' => $i), true);
            $setting = new admin_setting_configtext($name, $title, $description, "");
            $tab->add($setting);
            ...
            $title = get_string('oneslidecaption', 'theme_boost_union', array('no' => $i), true);
            $description = get_string('oneslidecaption_desc', 'theme_boost_union', array('no' => $i), true);
            $setting = new admin_setting_configtext($name, $title, $description, "");
            $tab->add($setting);
            ...
            $title = get_string('oneslidecontent', 'theme_boost_union', array('no' => $i), true);
            $description = get_string('oneslidecontent_desc', 'theme_boost_union', array('no' => $i), true);
            $setting = new admin_setting_confightmleditor($name, $title, $description, "");
            $tab->add($setting);
